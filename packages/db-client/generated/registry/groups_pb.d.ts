...
export class CompatibilitySettings extends jspb.Message { 
    ...
    getMode(): registry_shared_pb.CompatibilityMode;
    setMode(value: registry_shared_pb.CompatibilityMode): CompatibilitySettings;
...
export namespace CompatibilitySettings {
    export type AsObject = {
        enforce: boolean,
        mode: registry_shared_pb.CompatibilityMode,
    }
}
...
export class DataFormatSettings extends jspb.Message { 
    ...
    getFormat(): registry_shared_pb.SchemaDataFormat;
    setFormat(value: registry_shared_pb.SchemaDataFormat): DataFormatSettings;
...
export namespace DataFormatSettings {
    export type AsObject = {
        enforce: boolean,
        format: registry_shared_pb.SchemaDataFormat,
    }
}
