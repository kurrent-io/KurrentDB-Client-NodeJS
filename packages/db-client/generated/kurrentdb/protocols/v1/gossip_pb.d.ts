...
export class MemberInfo extends jspb.Message { 
    ...
    getInstanceId(): kurrentdb_protocols_v1_shared_pb.UUID | undefined;
    setInstanceId(value?: kurrentdb_protocols_v1_shared_pb.UUID): MemberInfo;
    getTimeStamp(): string;
...
export namespace MemberInfo {
    export type AsObject = {
        instanceId?: kurrentdb_protocols_v1_shared_pb.UUID.AsObject,
        timeStamp: string,
