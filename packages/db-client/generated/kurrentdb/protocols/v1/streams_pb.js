...
goog.object.extend(proto, kurrentdb_protocols_v1_shared_pb);
var kurrentdb_protocols_v1_status_pb = require('../../../kurrentdb/protocols/v1/status_pb.js');
goog.object.extend(proto, kurrentdb_protocols_v1_status_pb);
...
proto.event_store.client.streams.ReadReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noFilter: (f = msg.getNoFilter()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
...
proto.event_store.client.streams.ReadReq.Options.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 7:
      ...
      break;
    case 8:
      var value = new kurrentdb_protocols_v1_shared_pb.Empty;
      reader.readMessage(value,kurrentdb_protocols_v1_shared_pb.Empty.deserializeBinaryFromReader);
...
proto.event_store.client.streams.ReadReq.Options.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      8,
      f,
      kurrentdb_protocols_v1_shared_pb.Empty.serializeBinaryToWriter
    );
  }
...
proto.event_store.client.streams.ReadReq.Options.StreamOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    streamIdentifier: (f = msg.getStreamIdentifier()) && kurrentdb_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
    revision: jspb.Message.getFieldWithDefault(msg, 2, "0"),
    start: (f = msg.getStart()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    end: (f = msg.getEnd()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.streams.ReadReq.Options.StreamOptions.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new kurrentdb_protocols_v1_shared_pb.StreamIdentifier;
      reader.readMessage(value,kurrentdb_protocols_v1_shared_pb.StreamIdentifier.deserializeBinaryFromReader);
...
proto.event_store.client.streams.ReadReq.Options.StreamOptions.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      kurrentdb_protocols_v1_shared_pb.StreamIdentifier.serializeBinaryToWriter
    );
  }
...
proto.event_store.client.streams.ReadReq.Options.StreamOptions.prototype.getStreamIdentifier = function() {
  return /** @type{?proto.event_store.client.StreamIdentifier} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.StreamIdentifier, 1));
};
...
proto.event_store.client.streams.ReadReq.Options.StreamOptions.prototype.getStart = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 3));
};
...
proto.event_store.client.streams.ReadReq.Options.StreamOptions.prototype.getEnd = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 4));
};
...
proto.event_store.client.streams.ReadReq.Options.AllOptions.prototype.getStart = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 2));
};
...
proto.event_store.client.streams.ReadReq.Options.FilterOptions.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    count: (f = msg.getCount()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
...
proto.event_store.client.streams.ReadReq.Options.UUIDOption.toObject = function(includeInstance, msg) {
  var f, obj = {
    structured: (f = msg.getStructured()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    string: (f = msg.getString()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.streams.ReadReq.Options.UUIDOption.prototype.getStructured = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 1));
};
...
proto.event_store.client.streams.ReadReq.Options.prototype.getNoFilter = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 8));
};
...
proto.event_store.client.streams.ReadResp.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    lastAllStreamPosition: (f = msg.getLastAllStreamPosition()) && kurrentdb_protocols_v1_shared_pb.AllStreamPosition.toObject(includeInstance, f),
...
proto.event_store.client.streams.ReadResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 6:
      ...
      break;
    case 7:
      var value = new kurrentdb_protocols_v1_shared_pb.AllStreamPosition;
      reader.readMessage(value,kurrentdb_protocols_v1_shared_pb.AllStreamPosition.deserializeBinaryFromReader);
...
proto.event_store.client.streams.ReadResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      7,
      f,
      kurrentdb_protocols_v1_shared_pb.AllStreamPosition.serializeBinaryToWriter
    );
  }
...
proto.event_store.client.streams.ReadResp.ReadEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noPosition: (f = msg.getNoPosition()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.streams.ReadResp.ReadEvent.RecordedEvent.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: (f = msg.getId()) && kurrentdb_protocols_v1_shared_pb.UUID.toObject(includeInstance, f),
    streamIdentifier: (f = msg.getStreamIdentifier()) && kurrentdb_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
...
proto.event_store.client.streams.ReadResp.ReadEvent.RecordedEvent.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new kurrentdb_protocols_v1_shared_pb.UUID;
      reader.readMessage(value,kurrentdb_protocols_v1_shared_pb.UUID.deserializeBinaryFromReader);
      msg.setId(value);
      break;
    case 2:
      var value = new kurrentdb_protocols_v1_shared_pb.StreamIdentifier;
...
proto.event_store.client.streams.ReadResp.ReadEvent.RecordedEvent.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      kurrentdb_protocols_v1_shared_pb.UUID.serializeBinaryToWriter
    );
  }
  f = message.getStreamIdentifier();
  if (f != null) {
...
proto.event_store.client.streams.ReadResp.ReadEvent.RecordedEvent.prototype.getId = function() {
  return /** @type{?proto.event_store.client.UUID} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.UUID, 1));
};
...
proto.event_store.client.streams.ReadResp.ReadEvent.RecordedEvent.prototype.getStreamIdentifier = function() {
  return /** @type{?proto.event_store.client.StreamIdentifier} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.StreamIdentifier, 2));
};
...
proto.event_store.client.streams.ReadResp.prototype.getLastAllStreamPosition = function() {
  return /** @type{?proto.event_store.client.AllStreamPosition} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.AllStreamPosition, 7));
};
...
proto.event_store.client.streams.AppendReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    streamIdentifier: (f = msg.getStreamIdentifier()) && kurrentdb_protocols_v1_shared_pb.StreamIdentifier.toObject(includeInstance, f),
    revision: jspb.Message.getFieldWithDefault(msg, 2, "0"),
    noStream: (f = msg.getNoStream()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    any: (f = msg.getAny()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    streamExists: (f = msg.getStreamExists()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.streams.AppendReq.Options.prototype.getStreamExists = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 5));
};
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noStream2060: (f = msg.getNoStream2060()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedRevision2060: jspb.Message.getFieldWithDefault(msg, 3, 0),
    any2060: (f = msg.getAny2060()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    streamExists2060: (f = msg.getStreamExists2060()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    currentRevision: jspb.Message.getFieldWithDefault(msg, 6, "0"),
    currentNoStream: (f = msg.getCurrentNoStream()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedRevision: jspb.Message.getFieldWithDefault(msg, 8, "0"),
    expectedAny: (f = msg.getExpectedAny()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedStreamExists: (f = msg.getExpectedStreamExists()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    expectedNoStream: (f = msg.getExpectedNoStream()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.prototype.getCurrentNoStream = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 7));
};
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.prototype.getExpectedAny = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 9));
};
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.prototype.getExpectedStreamExists = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 10));
};
...
proto.event_store.client.streams.AppendResp.WrongExpectedVersion.prototype.getExpectedNoStream = function() {
  return /** @type{?proto.event_store.client.Empty} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.Empty, 11));
};
...
proto.event_store.client.streams.BatchAppendReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    correlationId: (f = msg.getCorrelationId()) && kurrentdb_protocols_v1_shared_pb.UUID.toObject(includeInstance, f),
...
proto.event_store.client.streams.BatchAppendResp.toObject = function(includeInstance, msg) {
  var f, obj = {
    correlationId: (f = msg.getCorrelationId()) && kurrentdb_protocols_v1_shared_pb.UUID.toObject(includeInstance, f),
    error: (f = msg.getError()) && kurrentdb_protocols_v1_status_pb.Status.toObject(includeInstance, f),
...
proto.event_store.client.streams.BatchAppendResp.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new kurrentdb_protocols_v1_status_pb.Status;
      reader.readMessage(value,kurrentdb_protocols_v1_status_pb.Status.deserializeBinaryFromReader);
      msg.setError(value);
      break;
    case 3:
...
proto.event_store.client.streams.BatchAppendResp.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      2,
      f,
      kurrentdb_protocols_v1_status_pb.Status.serializeBinaryToWriter
    );
  }
  f = message.getSuccess();
  if (f != null) {
...
proto.event_store.client.streams.BatchAppendResp.Success.toObject = function(includeInstance, msg) {
  var f, obj = {
    currentRevision: jspb.Message.getFieldWithDefault(msg, 1, "0"),
    noStream: (f = msg.getNoStream()) && google_protobuf_empty_pb.Empty.toObject(includeInstance, f),
    position: (f = msg.getPosition()) && kurrentdb_protocols_v1_shared_pb.AllStreamPosition.toObject(includeInstance, f),
...
proto.event_store.client.streams.BatchAppendResp.Success.prototype.getPosition = function() {
  return /** @type{?proto.event_store.client.AllStreamPosition} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.AllStreamPosition, 3));
};
...
proto.event_store.client.streams.BatchAppendResp.prototype.getError = function() {
  return /** @type{?proto.google.rpc.Status} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_status_pb.Status, 2));
};
...
proto.event_store.client.streams.BatchAppendResp.prototype.getStreamIdentifier = function() {
  return /** @type{?proto.event_store.client.StreamIdentifier} */ (
    jspb.Message.getWrapperField(this, kurrentdb_protocols_v1_shared_pb.StreamIdentifier, 4));
};
