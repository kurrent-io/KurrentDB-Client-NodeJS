// source: kurrentdb/protocols/v1/projectionmanagement.proto
/**
 * @fileoverview
 * @enhanceable
...
proto.event_store.client.projections.UpdateReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noEmitOptions: (f = msg.getNoEmitOptions()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
...
proto.event_store.client.projections.StatisticsReq.Options.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    pb_transient: (f = msg.getTransient()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    continuous: (f = msg.getContinuous()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f),
    oneTime: (f = msg.getOneTime()) && kurrentdb_protocols_v1_shared_pb.Empty.toObject(includeInstance, f)
  };
