// package: google.rpc
// file: kurrentdb/protocols/v1/status.proto
...
export class Status extends jspb.Message { 
    getCode(): kurrentdb_protocols_v1_code_pb.Code;
    setCode(value: kurrentdb_protocols_v1_code_pb.Code): Status;
    getMessage(): string;
...
export namespace Status {
    export type AsObject = {
        code: kurrentdb_protocols_v1_code_pb.Code,
        message: string,
