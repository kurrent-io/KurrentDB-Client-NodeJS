...
export namespace ReadReq {
    ...
    export class Options extends jspb.Message { 
        ...
        hasAll(): boolean;
        clearAll(): void;
        getAll(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setAll(value?: kurrentdb_protocols_v1_shared_pb.Empty): Options;
        getGroupName(): string;
    ...
    export namespace Options {
        export type AsObject = {
            ...
            all?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
            groupName: string,
            bufferSize: number,
    ...
    export class Ack extends jspb.Message { 
        ...
        clearIdsList(): void;
        getIdsList(): Array<kurrentdb_protocols_v1_shared_pb.UUID>;
        setIdsList(value: Array<kurrentdb_protocols_v1_shared_pb.UUID>): Ack;
        addIds(value?: kurrentdb_protocols_v1_shared_pb.UUID, index?: number): kurrentdb_protocols_v1_shared_pb.UUID;
    ...
    export namespace Ack {
        export type AsObject = {
            ...
            idsList: Array<kurrentdb_protocols_v1_shared_pb.UUID.AsObject>,
        }
    }
    ...
    export class Nack extends jspb.Message { 
        ...
        clearIdsList(): void;
        getIdsList(): Array<kurrentdb_protocols_v1_shared_pb.UUID>;
        setIdsList(value: Array<kurrentdb_protocols_v1_shared_pb.UUID>): Nack;
        addIds(value?: kurrentdb_protocols_v1_shared_pb.UUID, index?: number): kurrentdb_protocols_v1_shared_pb.UUID;
...
export namespace ReadResp {
    ...
    export class ReadEvent extends jspb.Message { 
        ...
        getNoRetryCount(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setNoRetryCount(value?: kurrentdb_protocols_v1_shared_pb.Empty): ReadEvent;
    ...
    export namespace ReadEvent {
        export type AsObject = {
            ...
            retryCount: number,
            noRetryCount?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
        }
...
export namespace CreateReq {
    ...
    export class AllOptions extends jspb.Message { 
        ...
        setNoFilter(value?: kurrentdb_protocols_v1_shared_pb.Empty): AllOptions;
...
export namespace ReplayParkedReq {
    ...
    export class Options extends jspb.Message { 
        ...
        hasNoLimit(): boolean;
        clearNoLimit(): void;
        getNoLimit(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setNoLimit(value?: kurrentdb_protocols_v1_shared_pb.Empty): Options;
    ...
    export namespace Options {
        export type AsObject = {
            ...
            all?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
            stopAt: string,
            noLimit?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
        }
...
export namespace ListReq {
    ...
    export class Options extends jspb.Message { 
        ...
        getListAllSubscriptions(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setListAllSubscriptions(value?: kurrentdb_protocols_v1_shared_pb.Empty): Options;
    ...
    export namespace Options {
        export type AsObject = {
            listAllSubscriptions?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
    ...
    export class StreamOption extends jspb.Message { 
        ...
        hasStream(): boolean;
        clearStream(): void;
        getStream(): kurrentdb_protocols_v1_shared_pb.StreamIdentifier | undefined;
        setStream(value?: kurrentdb_protocols_v1_shared_pb.StreamIdentifier): StreamOption;

        hasAll(): boolean;
        clearAll(): void;
        getAll(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setAll(value?: kurrentdb_protocols_v1_shared_pb.Empty): StreamOption;
    ...
    export namespace StreamOption {
        export type AsObject = {
            stream?: kurrentdb_protocols_v1_shared_pb.StreamIdentifier.AsObject,
            all?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
        }
