...
export namespace CreateReq {
    ...
    export class Options extends jspb.Message { 
        ...
        hasOneTime(): boolean;
        clearOneTime(): void;
        getOneTime(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setOneTime(value?: kurrentdb_protocols_v1_shared_pb.Empty): Options;
    ...
    export namespace Options {
        export type AsObject = {
            oneTime?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
...
export namespace UpdateReq {
    ...
    export class Options extends jspb.Message { 
        ...
        getNoEmitOptions(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setNoEmitOptions(value?: kurrentdb_protocols_v1_shared_pb.Empty): Options;
    ...
    export namespace Options {
        export type AsObject = {
            ...
            query: string,
            emitEnabled: boolean,
            noEmitOptions?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
        }
...
export namespace StatisticsReq {
    ...
    export class Options extends jspb.Message { 
        ...
        hasTransient(): boolean;
        clearTransient(): void;
        getTransient(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setTransient(value?: kurrentdb_protocols_v1_shared_pb.Empty): Options;

        hasContinuous(): boolean;
        clearContinuous(): void;
        getContinuous(): kurrentdb_protocols_v1_shared_pb.Empty | undefined;
        setContinuous(value?: kurrentdb_protocols_v1_shared_pb.Empty): Options;
    ...
    export namespace Options {
        export type AsObject = {
            ...
            pb_transient?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
            continuous?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
            oneTime?: kurrentdb_protocols_v1_shared_pb.Empty.AsObject,
        }
