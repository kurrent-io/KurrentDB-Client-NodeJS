...
var kurrentdb_protocols_v1_operations_pb = require('../../../kurrentdb/protocols/v1/operations_pb.js');
...
function serialize_event_store_client_operations_ScavengeResp(arg) {
  if (!(arg instanceof kurrentdb_protocols_v1_operations_pb.ScavengeResp)) {
...
function deserialize_event_store_client_operations_ScavengeResp(buffer_arg) {
  return kurrentdb_protocols_v1_operations_pb.ScavengeResp.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_operations_SetNodePriorityReq(arg) {
  if (!(arg instanceof kurrentdb_protocols_v1_operations_pb.SetNodePriorityReq)) {
...
function deserialize_event_store_client_operations_SetNodePriorityReq(buffer_arg) {
  return kurrentdb_protocols_v1_operations_pb.SetNodePriorityReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_operations_StartScavengeReq(arg) {
  if (!(arg instanceof kurrentdb_protocols_v1_operations_pb.StartScavengeReq)) {
...
function deserialize_event_store_client_operations_StartScavengeReq(buffer_arg) {
  return kurrentdb_protocols_v1_operations_pb.StartScavengeReq.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_event_store_client_operations_StopScavengeReq(arg) {
  if (!(arg instanceof kurrentdb_protocols_v1_operations_pb.StopScavengeReq)) {
...
function deserialize_event_store_client_operations_StopScavengeReq(buffer_arg) {
  return kurrentdb_protocols_v1_operations_pb.StopScavengeReq.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var OperationsService = exports.OperationsService = {
  startScavenge: {
    ...
    requestType: kurrentdb_protocols_v1_operations_pb.StartScavengeReq,
    responseType: kurrentdb_protocols_v1_operations_pb.ScavengeResp,
  ...
  stopScavenge: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kurrentdb_protocols_v1_operations_pb.StopScavengeReq,
    responseType: kurrentdb_protocols_v1_operations_pb.ScavengeResp,
  ...
  setNodePriority: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: kurrentdb_protocols_v1_operations_pb.SetNodePriorityReq,
    responseType: kurrentdb_protocols_v1_shared_pb.Empty,
