...
import typescript_register_instrumentation_opentelemetry from '/src/content/_samples/clients/node/6.2.1/opentelemetry.ts?raw';
import typescript_setup_exporter_opentelemetry from '/src/content/_samples/clients/node/6.2.1/opentelemetry.ts?raw';
...
<Code lang="typescript" code={typescript_register_instrumentation_opentelemetry} />
...
<Code lang="typescript" code={typescript_setup_exporter_opentelemetry} />
