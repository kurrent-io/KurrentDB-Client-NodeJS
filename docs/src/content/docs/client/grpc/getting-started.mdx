...
import typescript_createClient_get_started from '/src/content/_samples/clients/node/6.2.1/get-started.ts?raw';
import typescript_createEvent_get_started from '/src/content/_samples/clients/node/6.2.1/get-started.ts?raw';
import typescript_appendEvents_get_started from '/src/content/_samples/clients/node/6.2.1/get-started.ts?raw';
import typescript_readStream_get_started from '/src/content/_samples/clients/node/6.2.1/get-started.ts?raw';
...
<Code lang="typescript" code={typescript_createClient_get_started} />
...
<Code lang="typescript" code={typescript_createEvent_get_started} />
...
<Code lang="typescript" code={typescript_appendEvents_get_started} />
...
<Code lang="typescript" code={typescript_readStream_get_started} />
