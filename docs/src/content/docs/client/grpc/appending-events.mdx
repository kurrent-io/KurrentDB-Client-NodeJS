...
import typescript_append_to_stream_appending_events from '/src/content/_samples/clients/node/6.2.1/appending-events.ts?raw';
import typescript_append_duplicate_event_appending_events from '/src/content/_samples/clients/node/6.2.1/appending-events.ts?raw';
import typescript_append_with_no_stream_appending_events from '/src/content/_samples/clients/node/6.2.1/appending-events.ts?raw';
import typescript_append_with_concurrency_check_appending_events from '/src/content/_samples/clients/node/6.2.1/appending-events.ts?raw';
import typescript_overriding_user_credentials_appending_events from '/src/content/_samples/clients/node/6.2.1/appending-events.ts?raw';
...
<Code lang="typescript" code={typescript_append_to_stream_appending_events} />
...
<Code lang="typescript" code={typescript_append_duplicate_event_appending_events} />

![Duplicate Event](/assets/img/doc-imgs/client/grpc/images/duplicate-event.webp)
...
<Tabs>
  <TabItem label="TypeScript">
    <Code lang="typescript" code={typescript_append_with_no_stream_appending_events} />
  </TabItem>
</Tabs>
...
<Code lang="typescript" code={typescript_append_with_concurrency_check_appending_events} />
...
<Code lang="typescript" code={typescript_overriding_user_credentials_appending_events} />