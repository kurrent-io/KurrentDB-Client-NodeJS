...
import typescript_client_with_user_certificates_user_certificates from '/src/content/_samples/clients/node/6.2.1/user-certificates.ts?raw';

import { Badge, Code, TabItem, Tabs } from '@astrojs/starlight/components';


## Client x.509 certificate <Badge text="Commercial" variant="caution" />
...
<Code lang="typescript" code={typescript_client_with_user_certificates_user_certificates} />